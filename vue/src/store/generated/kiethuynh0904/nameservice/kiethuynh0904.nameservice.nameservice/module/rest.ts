...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/kiethuynh0904/nameservice/nameservice/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<NameserviceQueryParamsResponse, RpcStatus>({
      path: `/kiethuynh0904/nameservice/nameservice/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/kiethuynh0904/nameservice/nameservice/whois
   */
  queryWhoisAll = (
    query?: {
    ...
    this.request<NameserviceQueryAllWhoisResponse, RpcStatus>({
      path: `/kiethuynh0904/nameservice/nameservice/whois`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/kiethuynh0904/nameservice/nameservice/whois/{index}
   */
  queryWhois = (index: string, params: RequestParams = {}) =>
    this.request<NameserviceQueryGetWhoisResponse, RpcStatus>({
      path: `/kiethuynh0904/nameservice/nameservice/whois/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
