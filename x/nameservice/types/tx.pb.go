...
func init() {
	...
	proto.RegisterType((*MsgDeleteName)(nil), "kiethuynh0904.nameservice.nameservice.MsgDeleteName")
	proto.RegisterType((*MsgDeleteNameResponse)(nil), "kiethuynh0904.nameservice.nameservice.MsgDeleteNameResponse")
}
...
var fileDescriptor_df4dec9b515ec245 = []byte{
	...
	0x54, 0x16, 0xa4, 0x16, 0x27, 0xb1, 0x81, 0xb3, 0x88, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x94,
	0xf6, 0xab, 0x4b, 0x3a, 0x03, 0x00, 0x00,
}
...
func (c *msgClient) DeleteName(ctx context.Context, in *MsgDeleteName, opts ...grpc.CallOption) (*MsgDeleteNameResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kiethuynh0904.nameservice.nameservice.Msg/DeleteName", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_DeleteName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kiethuynh0904.nameservice.nameservice.Msg/DeleteName",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
